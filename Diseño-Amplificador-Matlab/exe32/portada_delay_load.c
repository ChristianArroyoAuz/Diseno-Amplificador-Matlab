 ...
 */
FARPROC WINAPI portadaDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = portadaDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = portadaDelayLoadWin32FailureHook;
#endif
